...
public class Steering : SubsystemTemplate
{
	public float deltaSteering = 25f; // (degrees / second)


	public void KillSwitch() { manager.subToManage.steering = 0; }
	...
	public override void LeftStickX(float value) { UpdateSteering(value); }
	...
	public override void ButtonEast_Down() { KillSwitch(); }
