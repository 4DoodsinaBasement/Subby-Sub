...
public class Throttle : SubsystemTemplate
{
    public float deltaThrottle = 30; // (percent / second)


    public void KillSwitch() { manager.SubToManage.throttle = 0; }
    ...
    public override void LeftStickY(float value) { UpdateThrottle(value);}
