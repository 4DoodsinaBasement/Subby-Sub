...
public class Buoyancy : SubsystemTemplate
{
    ...
    public void BuoyancyZero() { manager.SubToManage.buoyancy = 0; }


    public override void LeftStickX(float value) { }
    public override void LeftStickY(float value) { UpdateDepth(value); }
